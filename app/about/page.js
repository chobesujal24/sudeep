      ...
      <section className="pt-32 pb-16 relative overflow-hidden bg-[#FFFFFF]">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <nav className="text-xs text-[#475569] mb-6 flex gap-2">
            ...
            <span>/</span><span className="text-[#1E293B]">About</span>
          </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className={`bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-8 animate-on-scroll delay-${(i % 5) + 1}`}>
                ...
                <p className="text-[#1E293B] opacity-80 text-sm leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="animate-on-scroll">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-[#1E293B] opacity-80 text-sm">
      ...
      <section className="py-20 bg-[#FFFFFF] border-t border-[#E2E8F0]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-on-scroll delay-2">
              <div className="rounded-2xl overflow-hidden border border-[#E2E8F0] shadow-sm h-[400px]">
                <iframe
