...
function transformUrls(obj) {
  ...
  if (typeof obj === 'string') {
    ...
    // 2. Transfrom relative paths (found in local fallback) to Supabase Storage URL
    if (transformed.startsWith('/products/') || transformed.startsWith('/catalogs/')) {
      transformed = 'https://ceawmxeopfmvjywmbsen.supabase.co/storage/v1/object/public/images' + transformed;
    }
